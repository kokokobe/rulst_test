...
// 关卡三
static BATTLE_POINT_3: (i32, i32) = (820, 879);
// 关卡四
...
// 大跳确认
static CONFIRM: (i32, i32) = (537, 930);
// 喝水选择 100
...
fn play() {
    ...
    loop {
        let battle_point = BATTLE_POINT_1;
        //选关，开始挑战
        mouse.start_end_point_click(battle_point, battle_point, false);
        mouse.start_end_point_click(battle_point, battle_point, false);
